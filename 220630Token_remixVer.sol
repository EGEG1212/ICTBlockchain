...
abstract contract OwnerHelper {
    ...
    function transferOwnership(address newOwner) onlyOwner public {
        ...
        require(newOwner != address(0x0)); //잘못된주소는아닌지
        _owner = newOwner; //오너가바뀔때마다 덮어씌움
        emit OwnershipTransFerred(_owner, newOwner); //기록남기기
    }
}
...
interface ERC20Interface {
    ...
    contract SimpleToken is ERC20Interface, OwnerHelper {
        ...
        function transferFrom(address sender, address recipient, uint256 amount) external virtual override returns (bool) {
            ...
            uint256 currentAllownace = _allowances[sender][msg.sender];
            require(currentAllownace >= amount, "ERC20: transfer amount exceeds allowance");
            _approve(sender, msg.sender, currentAllownace, currentAllownace.sub(amount));
            return true;
        }
        ...
        function _transfer(address sender, address recipient, uint256 amount) internal virtual{
            ...
            require(isTokenLock(sender, recipient) == false, "TokenLock: invalid token transfer");//락상태확인
        ...
        function _approve(address owner, address spender, uint256 currentAllownace, uint256 amount)
        internal virtual {
            require(owner != address(0), "ERC20: approve from the zero address");
            require(spender != address(0), "ERC20: transfer to the zero address");
            require(currentAllownace == _allowances[owner][spender], "ERC20: invalid currentAmount");
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, currentAllownace, amount);
        }
        ...
        function isTokenLock(address from,  address to) public view returns (bool lock) {
            ...
            if(_personalTokenLock[from] == true || _personalTokenLock[to] == true) {//둘중에하나라도 락걸려있음 안돼.
                lock = true;
            }
        }
